        ...
        {step === 'preview' && (
          <div className="animate-in fade-in duration-500 pb-20">
             <div className="flex justify-between items-center mb-10 print:hidden">
                ...
                <Button size="lg" className="gradient-button px-10 rounded-2xl font-bold shadow-sky-500/20" onClick={() => window.print()}><Printer className="w-5 h-5 mr-3" /> Print Proposal</Button>
             </div>
             ...
             <div className="print-container bg-white text-slate-900 p-20 shadow-2xl rounded-3xl">
                           ...
                           <Table>
                              <TableBody>
                                 {billableItems.map(item => (
                                    <TableRow key={item.id} className="border-b border-slate-50 hover:bg-transparent h-10">
                                       ...
                                       <TableCell className="text-right font-mono text-[11px] font-bold pr-0">${(item.unit_price * item.qty).toFixed(2)}</TableCell>
                                    </TableRow>
                                 ))}
                              </TableBody>
                           </Table>
                ...
                <div className="mt-20 text-[9px] text-slate-400 text-center uppercase tracking-widest">Authorized Proposal • Valid for 30 Days</div>
             </div>
          </div>
        )}
      </div>
